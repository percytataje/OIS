<?php
	if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
		file_put_contents('../../gallery.html', stripslashes($_POST['indexhtml']));
		file_put_contents('../../css/coverflow.css', stripslashes($_POST['stylecss']));
	}
	if(! is_writable('../../gallery.html')) printf('gallery.html file is not writable<br>');
	if(! is_writable('../../css/coverflow.css')) printf('coverflow.css file is not writable<br>');
